...
<svelte:head>
  ...
  />
  <link
    href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,400..700;1,400..700&family=Inter:wght@100..900&family=Newsreader:ital,wght@0,200..800;1,200..800&display=swap"
    rel="stylesheet"
  />
...
<style lang="scss">
  ...
  #scroll {
    ...
    margin: 12px;
    background: rgba(#030025, 0.3);
    background: white;
    border-radius: 5px;
    box-shadow: 20px 8px 32px rgba(black, 0.5);
    z-index: 2;
    overflow: hidden;
    ...
    #bar {
      ...
      box-shadow:
        20px 8px 32px rgba(black, 0.5),
        inset 3px 0px 3px rgba(white, 0.4),
        inset -2px 0px 2px rgba(white, 0.9);
