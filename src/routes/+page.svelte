	...
	<div class="container">
		...
		<div class="mast">
			<div class="expo">
				...
				<p>
					I really like the <a href='https://www.w3schools.com/html/html5_canvas.asp'> <code> &lt;canvas&gt; </code> </a> element. <br> <br>
					Currently, I'm interested in building a new <a href="https://x.com/karpathy/status/1917920257257459899?lang=en">UX paradigm</a> for generative AI applications. <br> <br>
					Let's collaborate! Reach out anytime at <a href="mailto:ahnheewon823@gmail.com">ahnheewon823@gmail.com</a>.
				</p>
		...
		<div class='grid'>
			<div class='video'>
				<a href="https://gmv.stan.store">
					<video src='/video/stan_gmv.mov' autoplay loop muted playsinline></video>
				</a>
				<h4>
					Stan GMV Tracker
				...
				<p>A live, public-facing dashboard tracking Stan's <a href="https://gmv.stan.store">Gross Merchandise Value</a> in realtime.</p>
			</div>
			<div class='video'>
				<a href="https://stan.store">
					<video src='/video/stan_remix.mov' autoplay loop muted playsinline></video>
				</a>
				<h4>
					Stan Remix
					<span class='date'>2024</span>
		...
		<div class="title" id="games">
			<h2>Games</h2>
			<p>Fun web games I built in the pre-AI era — graphics and code all hand-created!</p>
		</div>
		...
		<div class='sections'>
			<div class='video'>
				<div class='expo'>
					...
					<h4>Platformr</h4>
					<p>A creator economy platform for digital products and personal storefronts.</p>
					<div class="tags">
						<a href="https://platformr.xyz" class="noud">
							<div class="tag link">
								<img src="arrow_top_right.svg" class='arrow_top_right' alt="">
								<h2>Visit</h2>
							</div>
						</a>
					</div>
				...
				<a href="https://platformr.xyz" class="noud">
					<video src='video/platformr.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
			...
			<div class='video'>
				<div class='expo'>
					...
					<h4>11 Rooms</h4>
					<p>An atmospheric puzzle game set across 11 mysterious rooms.</p>
					<div class="tags">
				...
				<a href="https://shelost.github.io/11rooms" class="noud">
					<video src='video/rooms.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
			...
			<div class='video'>
				<div class='expo'>
					...
					<p>A physics-based space game about orbital gravity and planetary motion.</p>
					<div class="tags">
				...
				<a href="https://shelost.github.io/orbiting" class="noud">
					<video src='video/orbiting.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
			...
			<div class='video'>
				<div class='expo'>
					...
					<h4>Wordchain</h4>
					<p>A word puzzle where every answer begins with the last letter of the previous one.</p>
					<div class="tags">
				...
				<a href="https://shelost.github.io/wordchain" class="noud">
					<video src='video/wordchain.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
			...
			<div class='video'>
				<div class='expo'>
					...
					<h4>Trails</h4>
					<p>A particle art game where gravity and motion create colorful trails.</p>
					<div class="tags">
				...
				<a href="https://shelost.github.io/trails" class="noud">
					<video src='video/trails.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
			...
			<div class='video'>
				<div class='expo'>
					...
					<h4>Super Pong</h4>
					<p>A high-speed, particle-charged remake of the classic Pong arcade game.</p>
					<div class="tags">
				...
				<a href="https://shelost.github.io/superpong" class="noud">
					<video src='video/pong.mp4' autoplay loop muted playsinline></video>
				</a>
			</div>
		</div>
		...
		<div class='grid'>
			<div class='video'>
				...
				<p>Realtime AI image generation, based on Tldraw's <a href="https://drawfast.tldraw.com/">Drawfast</a></p>
			</div>
			<div class='video'>
		...
		<ul>
			...
			<li>
				<a href="/persia">The Roman-Persian Wars<span class="date">2025</span></a>
				<Battery percentage={routeCompletion['/persia']} />
			</li>
			<li>
				<a href="/timeline">The Civilization Timeline<span class="date">2024</span></a>
				<Battery percentage={routeCompletion['/timeline']} />
			</li>
			<li>
				<a href="/mario">The Super Mario Bros. Movie Review<span class="date">2023</span></a>
		...
		<div class="title" id="comics">
			<h2>Comics</h2>
			<p>My childhood dream was to become a comic artist, and I'm getting there one day at a time!</p>
		</div>
		...
		<ul>
			...
			<div class="elem">
				<div class="header">
					<img src="title-samhan.png" alt="King of Samhan" class="logo horizontal">
					<div class="title-row">
					...
					<div class='expo'>
						...
						<p>I did a lot of research for this project, which may one day materialize.</p>
					</div>
					<div class="tags">
		...
		<div class="title" id="research">
			<h2>Research</h2>
			<p>While in school, I worked on solving the ARC challenge with <a href="https://www.cs.cornell.edu/~ellisk/">Prof. Kevin Ellis</a>.</p>
		</div>
		...
		<ul>
			<div class="elem">
				<div class="header">
					...
					<p>An extremely cleverly named ARC annotation web tool, which generates JSON files with specially annotated objects from raw ARC data.</p>
					<div class='tags'>
...
<style lang="scss">
	...
	@import url('https://fonts.googleapis.com/css2?family=Google+Sans+Flex:ital,wght@0,100..900;1,100..900&display=swap');

	$default: 'Google Sans Flex', sans-serif;

	h1, h2, h3, h4, p, span, li, button, a {
		font-family: $default;
	}
	...
	.sections {
		...
		.video {
			...
			video, .screenshot {
				...
				box-shadow: -4px 24px 48px rgba(black, .1);
			}
			.screenshot {
				border: none;
				filter: drop-shadow(-4px 16px 32px rgba(black, .08));
			}
			.expo {
				flex: 1;
				display: flex;
			...
			.app {
				width: 80px;
				border-radius: 20px;
				filter: drop-shadow(-2px 8px 16px rgba(black, .1));
			}
			h4 {
				font-size: 30px;
				font-weight: 500;
	...
	.grid{
		...
		.video{
			...
			video{
				...
				border-radius: 12px;
				border: 2px solid rgba(white, 1);
				box-shadow: -4px 24px 36px rgba(#030025, .12);
			}
			h4{
				margin: 24px 0 6px 0;
	...
	nav {
		...
		padding: 4px;
		overflow: hidden;
		box-shadow: -12px 32px 48px rgba(black, .9);
	}
	...
	.toc {
		...
		ul {
			...
			flex-direction: column;
			gap: 2px;
			border-left: 1px solid rgba(#030025, .12);
		}
	...
	.logo {
		margin: 8px 0;
		height: 120px;
		filter: drop-shadow(-4px 12px 8px rgba(black, .1));
		&.horizontal {
			height: 80px;
		}
	}
	...
	.elem {
		...
		.space {
			...
			background: white;
			height: fit-content;
			box-shadow: -12px 24px 60px rgba(black, .1);
		}
	}
	...
	h1 {
		...
		a{
			font-weight: 500;
			border-bottom: 3px solid rgba(black, .15);
		}
	}
