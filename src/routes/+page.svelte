    ...
    <div class="sections">
      <div class="video">
        <div class="expo">
          ...
          <h4>Platformr</h4>
          <p>
            A creator economy platform for digital products and personal
            storefronts.
          </p>
          <div class="tags">
        ...
        <a href="https://platformr.xyz" class="noud">
          <video src="video/platformr.mp4" autoplay loop muted playsinline
          ></video>
        </a>
      </div>
      ...
      <div class="video">
        <div class="expo">
          ...
          <p>
            A physics-based space game about orbital gravity and planetary
            motion.
          </p>
          <div class="tags">
        ...
        <a href="https://shelost.github.io/orbiting" class="noud">
          <video src="video/orbiting.mp4" autoplay loop muted playsinline
          ></video>
        </a>
      </div>
      ...
      <div class="video">
        <div class="expo">
          ...
          <h4>Wordchain</h4>
          <p>
            A word puzzle where every answer begins with the last letter of the
            previous one.
          </p>
          <div class="tags">
        ...
        <a href="https://shelost.github.io/wordchain" class="noud">
          <video src="video/wordchain.mp4" autoplay loop muted playsinline
          ></video>
        </a>
      </div>
      ...
      <div class="video">
        <div class="expo">
          ...
          <h4>Trails</h4>
          <p>
            A particle art game where gravity and motion create colorful trails.
          </p>
          <div class="tags">
      ...
      <div class="video">
        <div class="expo">
          ...
          <h4>Super Pong</h4>
          <p>
            A high-speed, particle-charged remake of the classic Pong arcade
            game.
          </p>
          <div class="tags">
...
<style lang="scss">
  @import url("https://fonts.googleapis.com/css2?family=Google+Sans+Flex:ital,wght@0,100..900;1,100..900&family=Gowun+Batang:wght@400;700&display=swap");

  $default: "Gowun Batang", serif;
  ...
  .sections {
    ...
    .video {
      ...
      .screenshot {
        ...
        box-shadow: -4px 24px 48px rgba(black, 0.1);
      }
      .screenshot {
        border: none;
        filter: drop-shadow(-4px 16px 32px rgba(black, 0.08));
      }
      .expo {
        flex: 1;
        display: flex;
